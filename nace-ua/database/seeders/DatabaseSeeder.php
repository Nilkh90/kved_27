...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $naceJ = Nace2027::create([
            ...
            'level' => 'SECTION',
            'description' => "Ця секція включає виробництво і поширення інформації та культурного продукту, забезпечення способу передавання та поширення цих продуктів, а також даних та інформації, діяльність у сфері інформаційних технологій, оброблення даних та іншу діяльність у сфері інформаційних послуг.\n\n" .
